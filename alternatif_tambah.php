    ...
    <div class="col-sm-6">
        ...
        <form method="post" action="?m=alternatif_tambah">
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="kode_alternatif" value="<?=$_POST['kode_alternatif']?>"/>
            </div>
            <div class="form-group">
                <label>Nama Alternatif <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="nama_alternatif" value="<?=$_POST['nama_alternatif']?>"/>

        ...
        <form method="post" action="?m=kriteria_tambah">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="minmax">
                    <option></option>
                    <?=get_min_max_option($_POST['minmax'])?>
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="par_q" value="<?=$_POST['par_q']?>"/>
            </div>
            <div class="form-group">
                <label>Parameter p <span class="text-danger">*</span></label>
                <input class="form-control" type="text" name="par_p" value="<?=$_POST['par_p']?>"/>
            </div>
            <div class="form-group">

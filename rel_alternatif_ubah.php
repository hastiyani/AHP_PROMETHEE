...
<div class="row">
    <div class="col-sm-4">
        ...
        <?php
        $rows = $db->get_results("SELECT ra.ID, k.kode_kriteria, k.nama_kriteria, ra.nilai FROM tb_rel_alternatif ra INNER JOIN tb_kriteria k ON k.id_kriteria=ra.id_kriteria  WHERE id_alternatif='$_GET[ID]' ORDER BY kode_kriteria");
        foreach($rows as $row):?>
